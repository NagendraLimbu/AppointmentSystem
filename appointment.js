$(document).ready(function() {
    ...
    $("#submitForm").validate({
        ...
        submitHandler: function (form) {
            ...
            myAjaxCall("http://localhost/nag/insertAppointment.pl",
                data,
                "POST",
                updateTableData);
        }
    ...
    $("#btnSearch").click(function () {
        ...
        myAjaxCall("http://localhost/nag/searchAppointment.pl", data, "GET", loadOnSuccess);
    });
    ...
    function getAppointments(data) {
        myAjaxCall("http://localhost/nag/searchAppointment.pl", "", "GET", loadOnSuccess);
    }
